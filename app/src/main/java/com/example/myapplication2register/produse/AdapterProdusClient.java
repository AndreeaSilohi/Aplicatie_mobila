...
public class AdapterProdusClient extends RecyclerView.Adapter <ProdViewHolder>{
    private Context mContext;
    private List<ProdusPentruAdmin> myProdList;

    private int lastPosition=-1;

    public AdapterProdusClient(Context mContext, List<ProdusPentruAdmin> myProdList) {
    ...
    public void onBindViewHolder(@NonNull ProdViewHolder holder, int position) {
        ...
        holder.mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mContext,MainActivityDetailsProduse.class);
