...
public class AdapterClientReteta extends RecyclerView.Adapter <FoodViewHolderClient>{
    ...
    public AdapterClientReteta(Context mContext, List<RetetaPentruAdmin> myFoodList) {
    ...
    @NonNull
    @Override
    public FoodViewHolderClient onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mView= LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_row_item,parent,false);

        return new FoodViewHolderClient (mView);
    }

    @Override
    public void onBindViewHolder(@NonNull FoodViewHolderClient holder, int position) {
        Glide.with(mContext)
        ...
        holder.mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mContext,MainActivityDetails.class);
...
class FoodViewHolderClient extends RecyclerView.ViewHolder{
    ...
    public FoodViewHolderClient (View  itemView) {
        super(itemView);
